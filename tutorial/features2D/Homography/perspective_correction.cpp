...
void perspectiveCorrection(const string &img1Path, const string &img2Path,
  ...
  imshow("Desired chessboard view / Warped source chessboard view",
         img_draw_warp);
...
int main(int argc, char *argv[]) {
  ...
  perspectiveCorrection(parser.get<String>("image1"),
                        parser.get<String>("image2"), patternSize, rng);
