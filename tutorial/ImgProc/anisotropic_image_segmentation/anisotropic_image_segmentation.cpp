/**
 * @brief You will learn how to segment an anisotropic image with a single local
 * orientation by a gradient structure tensor (GST)
 * @author Karpushin Vladislav, karpushin@ngs.ru,
 * https://github.com/VladKarpushin
 */
...
//! [calcGST_proto]
void calcGST(const Mat& inputImg, Mat& imgCoherencyOut, Mat& imgOrientationOut,
             int w);
//! [calcGST_proto]
