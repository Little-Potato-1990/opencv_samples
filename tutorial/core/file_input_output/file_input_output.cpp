...
static void help(char** av) {
  cout << endl
       ...
       << "The output file may be either XML (xml) or YAML (yml/yaml). You can "
          "even compress it by "
       << "specifying this in its extension like xml.gz yaml.gz etc... " << endl
       << "With FileStorage you can serialize objects in OpenCV by using the "
          "<< and >> operators"
       << endl
...
int main(int ac, char** av) {
  ...
  {  // read
    ...
    //! [nonexist]
    cout << "Attempt to read NonExisting (should initialize the data structure "
            "with its default).";
    fs["NonExisting"] >> m;
