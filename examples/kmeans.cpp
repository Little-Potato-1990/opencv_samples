...
//             number of cluster\n" "centers and uses kmeans to move those
//             cluster centers to their representitive location\n" "Call\n"
//             "./kmeans\n" << endl;
// }

int main(int /*argc*/, char** /*argv*/) {
  const int MAX_CLUSTERS = 5;
  Scalar colorTab[] = {Scalar(0, 0, 255), Scalar(0, 255, 0),
                       Scalar(255, 100, 100), Scalar(255, 0, 255),
                       Scalar(0, 255, 255)};
