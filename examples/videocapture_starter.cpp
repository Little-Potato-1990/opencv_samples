 ...
 * @brief A starter sample for using OpenCV VideoCapture with capture devices,
 * video files or image sequences easy as CV_PI right?
 *
...
int process(VideoCapture& capture) {
  ...
  for (;;) {
    ...
    char key = (char)waitKey(30);  // delay N millis, usually long enough to
