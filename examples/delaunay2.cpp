...
static void help(char** argv) {
  cout << "\nThis program demonstrates iterative construction of\n"
          ...
          "It draws a random set of points in an image and then delaunay "
          "triangulates them.\n"
          "Usage: \n";
  cout << argv[0];
  cout << "\n\nThis program builds the triangulation interactively, you may "
          "stop this process by\n"
          "hitting any key.\n";
}
...
static void locate_point(Mat& img, Subdiv2D& subdiv, Point2f fp,
                         Scalar active_color) {
  int e0 = 0, vertex = 0;
