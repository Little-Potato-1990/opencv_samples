...
static void help(const char** argv) {
  cout << "\nThis program demonstrates the smile detector.\n"
          "Usage:\n"
       << argv[0]
       << " [--cascade=<cascade_path> this is the frontal face classifier]\n"
          "   [--smile-cascade=[<smile_cascade_path>]]\n"
          "   [--scale=<image scale greater or equal to 1, try 2.0 for "
          "example. The larger the faster the processing>]\n"
          "   [--try-flip]\n"
